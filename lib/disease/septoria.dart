...
class Septoria extends StatelessWidget {
  const Septoria({super.key});
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      //  crossAxisAlignment: CrossAxisAlignment.start,
        children: [
           Text(" The disease recognized is Septoria Leaf Spot",
              ...
              width:400,
               ...
               decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/demages/septoria.jpg',
