  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      //  crossAxisAlignment: CrossAxisAlignment.start,
        children: [
           Text("The disease recognized is Spider Mites",
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Text("A serious pest of tomato and other members of the potato family, both on indoor and field crops. The mites are difficult to see with the naked eye and better viewed with a hand lens or under a microscope.\n f you catch the mites early enough you can try spraying them off of the plant stems and leaves with the garden hose. ",
              ...
              width:400,
               ...
               decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/demages/spi.jpg',
